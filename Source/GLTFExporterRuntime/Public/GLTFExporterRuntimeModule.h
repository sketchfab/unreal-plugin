 ...
 */
class IGLTFExporterRuntimeModule : public IModuleInterface
{
public:
	/**
	 ...
	 */
	static IGLTFExporterRuntimeModule& Get()
	{
		return FModuleManager::LoadModuleChecked<IGLTFExporterRuntimeModule>("GLTFExporterRuntime");
	}
	...
	{
		return FModuleManager::Get().IsModuleLoaded("GLTFExporterRuntime");
	}
};
